...
if (isset($_POST['login'])) {
    ...
    if ($email === '' || $password === '') {
        ...
        $stmt = $conn->prepare("SELECT * FROM users WHERE email = ? AND role = 'receptionist'");
...
<body>
  <div class="login-container">
    ...
    <form method="POST" action="" autocomplete="on">
      ...
      <input type="email" id="email" name="email" placeholder="e.g. receptionist@email.com" required autocomplete="username">
