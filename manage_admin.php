...
if (isset($_POST['add_admin'])) {
    ...
    $check = $conn->prepare("SELECT id FROM users WHERE (username=? OR email=?) AND role='admin'");
...
<div class="container">
  ...
  <form method="POST">
    ...
    <button type="submit" name="add_admin"><i class="fas fa-plus"></i> Add Admin</button>
  </form>
  <table>
    <thead>
      ...
      <tr>
        ...
        <td>
          ...
          <form method="POST" style="display:inline;">
            ...
            <button type="submit" name="delete_admin" class="delete-btn"><i class="fas fa-trash"></i> Delete</button>
          </form>
          <?php else: ?>
