...
<div class="container">
  ...
  <form method="POST">
    ...
    <button type="submit" name="add_patient"><i class="fas fa-plus"></i> Add Patient</button>
  </form>
  <table>
    <thead>
      ...
      <tr>
        ...
        <td>
          <form method="POST" style="display:inline;">
            ...
            <button type="submit" name="delete_patient" class="delete-btn"><i class="fas fa-trash"></i> Delete</button>
